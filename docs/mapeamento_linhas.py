...
# Auxílio para organização das linhas para o usuário
...
LINHAS_METRO_CPTM = {
    ...
    "Linha 9 - Esmeralda": [
        ...
        "Cidade Universitária", "Pinheiros", "Hebraica-Rebouças", 
        "Cidade Jardim", "Vila Olímpia", "Berrini", "Morumbi", "Granja Julieta", 
    ...
    "Linha 11 - Coral": [
        ...
        "José Bonifácio", "Guaianases", "Antonio Gianetti Neto", "Ferraz de Vasconcelos", 
        "Poá", "Calmon Viana", "Suzano", "Jundiapeba", "Bráz Cubas", 
        "Mogi das Cruzes", "Estudantes"
    ],
    "Linha 12 - Safira": [
        "Brás", "Tatuapé", "Engenheiro Goulart", "USP Leste", 
        "Comendador Ermelino", "São Miguel Paulista", "Jardim Helena", 
        "Itaim Paulista", "Jardim Romano", "Engenheiro Manoel Feio", 
        "Itaquaquecetuba", "Aracaré", "Calmon Viana"
    ],
    "Linha 13 - Jade": [
